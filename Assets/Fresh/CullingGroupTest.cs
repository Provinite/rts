// https://github.com/unitycoder/GetNearestObjectsWithCullingGroup/blob/ae2f79b2511ebe5eb314630dcb3bd3af8ddc8310/LICENSE
// https://github.com/unitycoder/GetNearestObjectsWithCullingGroup/blob/ae2f79b2511ebe5eb314630dcb3bd3af8ddc8310/Assets/Scripts/CullingGroupExample.cs
using UnityEngine;
...
public class CullingGroupExample : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    cullGroup.SetBoundingDistances(
      new float[] { searchDistance, float.PositiveInfinity }
    );

    bounds = new BoundingSphere[4];
